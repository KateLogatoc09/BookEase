            ...
            <div>
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white" id="classy2">
                        <h3 class="text-white mb-4">Welcome to BookEase</h3>
                        <p class="mb-4">Fill up all the information needed to recover your account.</p>
           
                    </div>
                    <div class="col-md-6">
                        <h3 class="text-white mb-4 text-center" id="classy">Password Recovery</h3>
                        <?php if(isset($_SESSION['recovery'])): ?>
                            <?php if($_SESSION['recovery']): ?>
                                <form action='/recover' method='post'>
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-outline-light w-100 py-3" type="submit">Confirm</button>
                                        </div>
                                    </div>
                                </form>
                            <?php endif; ?>
                        <?php else: ?>
                            <form action='/recovering' method='post'>
                                <div class="row g-3">
                                    ...
                                    <a href="login" class="dark text-center" >Proceed to Login?</a>
                                </div>
                            </form>
                        <?php endif; ?>
                    </div>
