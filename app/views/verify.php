            ...
            <div>
                <div class="row g-5 align-items-center">
                    <div class="col-md-6 text-white" id="classy2">
                        <h3 class="text-white mb-4">Welcome to BookEase Verification Page</h3>
                        <p class="mb-4">Fill up all the information needed to verify your account.</p>
                    </div>
                    <div class="col-md-6">
                        <h3 class="text-white mb-4 text-center" id="classy">Verify Now</h3>
                        <form action='/verifying' method='post'>
                            <div class="row g-3">
                                <?php if(isset($_SESSION['email'])): ?>
                                    <div class="col-md-12"  id="color">
                                        <div class="form-floating">
                                            <input type="email" class="form-control bg-transparent" value="<?php if(isset($_SESSION['email'])): ?><?= $_SESSION['email']; endif;?>" placeholder="Your email" readonly>
                                            <label for="email">Your email</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12"  id="color">
                                        <div class="form-floating">
                                            <input type="text" class="form-control bg-transparent" name="code" placeholder="Verification Code">
                                            <label for="code">Verification Code</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4"  id="color">
                                        <div class="form-floating">
                                            <input type="submit" class="btn main-btn py-3 mx-auto w-100" name="resend" value="Resend">
                                        </div>
                                    </div>
                                    <div class="col-md-8"  id="color">
                                        <div class="form-floating">
                                            <input type="submit" class="btn btn-outline-light py-3 px-5 mx-auto w-100" name="verifying" value="Submit">
                                        </div>
                                    </div>
                                <?php else: ?>
                                    <div class="col-md-12"  id="color">
                                        <div class="form-floating">
                                            <input type="email" class="form-control bg-transparent" name="email" placeholder="Your email" required>
                                            <label for="email">Your email</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12"  id="color">
                                        <div class="form-floating">
                                            <input type="submit" class="btn btn-outline-light py-3 px-5 mx-auto w-100" name="sending" value="send" placeholder="Submit">
                                        </div>
                                    </div>
                                <?php endif; ?>
                                    <a href='/contact' class="dark" id="classy">Need Help? Contact Us</a>
                            </div>
                        </form>
                    </div>
                </div>
