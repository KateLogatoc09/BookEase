        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Resort /</span> Manage</h4>
                ...
                <div class="table-responsive text-nowrap rounded-3 h-px-500 invisible-scrollbar">
                  ...
                  <caption class="ms-4 position-sticky bottom-0">
                    ...
                    <?php foreach($rooms as $room): ?>
                      <tr>
                        <td><?php if(isset($room['id'])): ?><?= $room['id']; ?><?php endif; ?></td>
                        <td><img src="<?php if(isset($room['photo'])): ?><?= site_url().'/'.$room['photo']; ?><?php else: ?>public/default.jpg<?php endif; ?>" class="rounded-3 image" height="100" width="100" /></td>
                        <td><i class="fab fa-angular fa-lg text-danger"></i> <strong><?php if(isset($room['name'])): ?><?= $room['name']; ?><?php endif; ?></strong></td>
                        <td class="desc"><?php if(isset($room['description'])): ?><?= $room['description']; ?><?php endif; ?></td>
                        <td><span class="badge bg-label-primary me-1"><?php if(isset($room['pax'])): ?><?= $room['pax']; ?><?php endif; ?></span></td>
                        <td><?php if(isset($room['quantity'])): ?><?= $room['quantity']; ?><?php endif; ?></td>
                        <td>&#8369; <?php if(isset($room['original_price'])): ?><?= $room['original_price']; ?><?php endif; ?></td>
                        <td><?php if(isset($room['seasonal_rates'])): echo 100 * $room['seasonal_rates']; ?><?php endif; ?>%</td>
                        <td>&#8369; <?php if(isset($room['actual_price'])): ?><?= $room['actual_price']; ?><?php endif; ?></td>
                        <td><?php if(isset($room['id'])): ?><?= $room['status']; ?><?php endif; ?></td>
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="<?php echo site_url();?>/editroom_res/<?php if(isset($room['id'])): ?><?= $room['id']; ?><?php endif; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="<?php echo site_url();?>/delroom_res/<?php if(isset($room['id'])): ?><?= $room['id']; ?><?php endif; ?>"
              ...
              <div class="card my-4">
                <h5 class="card-header">Add/Edit Rooms</h5>
                <hr class="my-0">
                <form action="<?php echo site_url();?>/managerooms_res" method="POST" enctype="multipart/form-data">
                    <div class="card-body d-flex row">
                        <div class="col-sm-5 col-md-5 d-sm-block d-md-block align-items-sm-center">
                        <?php if(isset($selected['id'])): ?>
                        <input type="hidden" value="<?= $selected['id'];?>" id="room_id" name="id" />
                        <?php endif; ?>
                        <input type="hidden" value="RESORT" name="category" required/>
                      <?php if(isset($selected['photo'])): ?>
                        <img
                          src="<?= site_url().'/'.$selected['photo']; ?>"
                          alt="user-avatar"
                        ...
                        <div class="col-sm-7 col-md-7 d-sm-block d-md-block ps-2">
                            <div class="row">
                                ...
                                <div class="mb-2 col-md-6">
                                    ...
                                    <textarea class="form-control" id="description" name="description" style="resize:none" rows="4" required><?php if(isset($selected['description'])): echo $selected['description']; endif; ?></textarea>
                                </div>
                                ...
                                <div class="mb-2 col-md-6">
                                    ...
                                    id="qty"
                                    name="qty"
                                    value="<?php if(isset($selected['quantity'])): echo $selected['quantity']; endif; ?>"
                                    autofocus
                                    />
                                ...
                                <div class="mt-2">
                                <?php if(isset($selected['id'])): ?>
                                <a href="<?= site_url()?>/admin_resort_manage" class="btn btn-primary float-start" >Back to Insert</a>
                                <?php endif; ?>
