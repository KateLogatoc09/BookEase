        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Apartment /</span> Manage</h4>
                  ...
                  <caption class="ms-4 position-sticky bottom-0">
                    ...
                    <?php foreach($rooms as $room): ?>
                      <tr>
                        ...
                        <td><img src="<?php if(isset($room['photo'])): ?><?= site_url().'/'.$room['photo']; ?><?php else: ?>public/default.jpg<?php endif; ?>" class="rounded-3 image cursor-pointer" height="100" width="100" /></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="<?php echo site_url();?>/editroom_ap/<?php if(isset($room['id'])): ?><?= $room['id']; ?><?php endif; ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Edit</a
                              >
                              <a class="dropdown-item" href="<?php echo site_url();?>/delroom_ap/<?php if(isset($room['id'])): ?><?= $room['id']; ?><?php endif; ?>"
              ...
              <div class="card my-4">
                ...
                <form action="<?php echo site_url();?>/managerooms_ap" method="POST" enctype="multipart/form-data">
                    <div class="card-body d-flex row">
                        ...
                        <?php endif; ?>
                        <input type="hidden" value="APARTMENT" name="category" required/>
                      ...
                      <?php endif; ?>
                        ...
                        <div class="col-sm-7 col-md-7 d-sm-block d-md-block ps-2">
                            <div class="row">
                                ...
                                <div class="mt-2">
                                <?php if(isset($selected['id'])): ?>
                                <a href="<?= site_url()?>/admin_apartment_manage" class="btn btn-primary float-start" >Back to Insert</a>
                                <?php endif; ?>
