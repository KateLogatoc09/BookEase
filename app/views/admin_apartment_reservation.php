        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Apartment /</span> Reservations</h4>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="<?php echo site_url();?>/editres_ap/<?php if(isset($reservation['resid'])): ?><?= $reservation['resid']; ?><?php endif; ?>"
              ...
              <div class="card my-4">
                ...
                <hr class="my-0">
                <form action="<?php echo site_url();?>/manageres_ap" method="POST" enctype="multipart/form-data">
                              ...
                              <?php endif; ?>
                                ...
                                <div class="mb-2 col-md-3">
                                  <label for="html5-date-input" class="form-label">Check-in Date</label>
                                    <div class="col-md-12">
                                      <input class="form-control check_in cursor-pointer" type="text" value="<?php if(isset($selected['check_in'])): echo $selected['check_in']; endif; ?>" name="check_in" placeholder="Date" required/>
                                    </div>
                                </div>
                                  ...
                                  <div class="row">
                                    <div class= "col-md-6">
                                      ...
                                      > <?php if(isset($selected['room_id'])): ?>
                                        ...
                                        <?php endif; foreach($rooms as $room): ?>
                                        <?php if(isset($selected['room_id'])): ?>
                                    ...
                                    <label for="user" class="form-label">User</label>
                                      ...
                                      > <?php if(isset($selected['user_id'])): ?>
                                        ...
                                        <?php else: ?>
                                        <option>Choose an option</option>
                                        <?php endif; foreach($account as $acc): ?>
                                        <?php if(isset($selected['user_id'])): ?>
